...
# Load model.
if args.milan in ("clip-dissect", "test"):
    decoder = milan.pretrained("base", map_location=device)
...
def evaluate(predictions, score_file, test, bert_scorer):
...
evaluate(
    ...
    score_file=html_dir / "scores.csv",
    test=dataset,
