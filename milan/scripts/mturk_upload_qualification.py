...
parser.add_argument(
    "--no-validate-urls", action="store_true", help="do not validate image urls"
)
parser.add_argument(
    "--mockup-file", type=pathlib.Path, help="write mockup to this file"
)
parser.add_argument(
    "--name",
...
parser.add_argument(
    "--retry-delay-seconds", type=int, default=120, help="retry delay in seconds"
)
parser.add_argument(
