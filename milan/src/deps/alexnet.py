    ...
    def __init__(
        ...
        for name, module in [
            (
                "conv1",
                nn.Conv2d(
                    w[0], w[1], kernel_size=11, stride=4, groups=groups[0], bias=True
                ),
            ),
            ...
            (
                "conv2",
                nn.Conv2d(
                    w[1], w[2], kernel_size=5, padding=2, groups=groups[1], bias=True
                ),
            ),
            ...
            (
                "conv3",
                nn.Conv2d(
                    w[2], w[3], kernel_size=3, padding=1, groups=groups[2], bias=True
                ),
            ),
            ...
            (
                "conv4",
                nn.Conv2d(
                    w[3], w[4], kernel_size=3, padding=1, groups=groups[3], bias=True
                ),
            ),
            ...
            (
                "conv5",
                nn.Conv2d(
                    w[4], w[5], kernel_size=3, padding=1, groups=groups[4], bias=True
                ),
            ),
