...
KEYS.RESNET50_ROBUST_4x = "resnet50_robust_4x"
...
KEYS.RESNET50_ROBUST_4x_IMAGENET = f"{KEYS.RESNET50_ROBUST_4x}/{KEYS.IMAGENET}"
...
KEYS.VGG16_CIFAR10 = f"{KEYS.VGG16}/{KEYS.CIFAR10}"

KEYS.ALEXNET_IMAGENET_BLURRED = f"{KEYS.ALEXNET}/{KEYS.IMAGENET_BLURRED}"
KEYS.DENSENET121_IMAGENET_BLURRED = f"{KEYS.DENSENET121}/" f"{KEYS.IMAGENET_BLURRED}"
KEYS.DENSENET201_IMAGENET_BLURRED = f"{KEYS.DENSENET201}/" f"{KEYS.IMAGENET_BLURRED}"
...
KEYS.MOBILENET_V2_IMAGENET_BLURRED = f"{KEYS.MOBILENET_V2}/" f"{KEYS.IMAGENET_BLURRED}"
KEYS.SHUFFLENET_V2_X1_0_IMAGENET_BLURRED = (
    f"{KEYS.SHUFFLENET_V2_X1_0}/" f"{KEYS.IMAGENET_BLURRED}"
)
KEYS.SQUEEZENET1_0_IMAGENET_BLURRED = (
    f"{KEYS.SQUEEZENET1_0}/" f"{KEYS.IMAGENET_BLURRED}"
)
...
def default_dataset_configs(
    **others: hubs.DatasetConfig,  # Put overrides here!
    ...
    for model in (KEYS.RESNET18,):
        ...
        configs[key] = hubs.DatasetConfig(
            merges.maybe_merge_and_load_dataset, source="places365/val"
        )
