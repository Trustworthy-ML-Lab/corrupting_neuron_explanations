    ...
    def serialize(self, **kwargs: Any) -> Serialized:
        ...
        for key, value in properties.items():
            if key in children and not isinstance(value, Serializable):
                raise ValueError(
                    f'child "{key}" is not serializable '
...
SerializableModuleT = TypeVar("SerializableModuleT", bound="SerializableModule")
...
class SerializableModule(Serializable, nn.Module):
    ...
    def deserialize(
        ...
        **kwargs: Any,
        ...
        module = super(SerializableModule, cls).deserialize(
            serialized, load_state_dict=False, **kwargs
        )
    ...
    @classmethod
    def load(
        cls: Type[SerializableModuleT], file: PathLike, **kwargs: Any
    ) -> SerializableModuleT:
